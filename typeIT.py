...
class Window(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        #placeholder variables using in functions
    ...
    def menu(self):
       ...
       #action required to call the function we connect using self
...
#insert from voice
    ...
    def closeTabAccept(self, widget):
        if widget:
            widget.deleteLater()
        self.tab.removeTab(self.tab.currentIndex())
...
#==================================================================  PDF OPENS IN DEFAULT VIEWER            
            ...
            self.tab.addTab(self.textEdit, Path(name).name)
